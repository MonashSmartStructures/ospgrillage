...
test_bridge.op_create_elements(transedge1_prop, skew_tag, edge.beam_ele_type, expression='trans_edge_1')
...
test_bridge.op_create_elements(transedge2_prop, skew_tag, edge.beam_ele_type, expression='trans_edge_2')
