...
def test_point_load_getter(bridge_model_42_negative):  # test get_point_load_nodes() function
    ...
    assert example_bridge.load_case_list[0]['load_command'] == [
        'ops.load(12, *[0, 0.6075807082987861, 0, 0.3738958204915605, 0, 0.3416694313270197])\n',
...
def test_line_load_coincide_long_edge(bridge_model_42_negative):
    ...
    assert example_bridge.global_line_int_dict == [
        {5: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[4, 0, 1]]},
         6: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[4, 0, 1]]},
         27: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[10, 0, 1]]},
         28: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[10, 0, 1]]},
         29: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[10, 0, 1]]},
         30: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[10, 0, 1]]}}]
...
def test_line_load_coincide_edge_beam(bridge_model_42_negative):
    ...
    assert example_bridge.global_line_int_dict == [
        {9: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[5, 0, 1]]},
         10: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[5, 0, 1]]},
         27: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[10, 0, 1]]},
         28: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[10, 0, 1]]},
         29: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[10, 0, 1]]},
         30: {'long_intersect': [], 'trans_intersect': [], 'edge_intersect': [], 'ends': [[10, 0, 1]]}}]
...
def test_patch_load(bridge_model_42_negative):
    ...
    Lane = og.create_load(type="patch", point1=lane_point_1, point2=lane_point_2, point3=lane_point_3,
                          point4=lane_point_4, shape_function="hermite")
...
def test_moving_load_case(bridge_model_42_negative):
    ...
    front_wheel = og.create_load(type="point", name="front wheel", point1=og.LoadPoint(2, 0, 2, 50),
                                 shape_function="hermite")  # Single point load 50 N

    single_path = og.create_moving_path(start_point=og.Point(2, 0, 2),
                                        end_point=og.Point(4, 0, 3))  # create path object
...
def test_moving_load_and_basic_load_together(bridge_model_42_negative):
    ...
    front_wheel = og.PointLoad(name="front wheel", point1=og.LoadPoint(2, 0, 2, 50),
                               shape_function="hermite")  # Single point load 50 N
...
def test_moving_compound_load(bridge_model_42_negative):
    ...
    back_wheel = og.create_load(type="point", name="single point", point1=og.LoadPoint(5, 0, 2, 20),
                                shape_function="hermite")  # Single point load 20 N
    front_wheel = og.create_load(type="point", name="front wheel", point1=og.LoadPoint(2, 0, 2, 50),
                                 shape_function="hermite")  # Single point load 50 N
