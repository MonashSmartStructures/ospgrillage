...
class Mesh:
    ...
    # --------------------------------------------------------------------------------------------
        ...
        first = first_connecting_region_nodes[0]
        second = end_connecting_region_nodes[0]
        # loop each point in self.nox
        cor_fir = self.node_spec[first]['coordinate']
        cor_sec = self.node_spec[second]['coordinate']
