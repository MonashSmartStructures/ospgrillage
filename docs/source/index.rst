.. opsgrillage documentation master file, created by
...
create executable python scripts which contains commands to create a specified grillage models
1) Output an executable python scripts containing commands to create a specified grillage model
in Open System for Earthquake Engineering Simulation (OpenSees) software framework.
for use in Open System for Earthquake Engineering Simulation (OpenSees) software framework.
